...
This checklist maps the repository files to the course submission requirements.
...
- Project description: included in `README.md`.
- Data source information: included in `README.md` and `data/readme_data.txt`.
- Required packages: listed in `requirements.txt` and summarized in `README.md`.
- Instructions to run the code: included in `README.md` and `ReadMe.txt`.
